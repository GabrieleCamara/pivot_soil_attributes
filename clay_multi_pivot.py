...
# -- Adding a new column in attribute table of vlayer to receive stats mean of raster -- #
provider = vlayer.dataProvider()
raster_mean = QgsField("clay_mean", QVariant.Double)
provider.addAttributes([raster_mean])
vlayer.updateFields()

# -- Going through the pivots, each pivot is a mask to clip the raster -- #
count_pivot = 1
...
# Removes the last selection of vlayer 
